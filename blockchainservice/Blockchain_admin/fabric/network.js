...
exports.connectToNetwork = async function (userName) {
  ...
  try {
    ...
    const contract = await network.getContract('OperationContract');
...
exports.registerIdentity = async function (username) {
  ...
  try {
    ...
    let response = `Successfully registered user ${username} .`;
    return response;
  } catch (error) {
